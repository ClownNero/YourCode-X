...
export default function SqlInjection(props) {
  return (
    <div className="p-6">
      <div className="mb-6">
        <h3 className="font-[600] text-lg pb-2">설명</h3>
        <p>
          <span className="">SQL Injection(SQL 인젝션)</span>은 악의적인
      ...
      <div className="mb-6">
        <h3 className="font-[600] text-lg pb-2">발생 상황</h3>
      ...
      <div>
        <h3 className="font-[600] text-lg pb-2">위험도</h3>
